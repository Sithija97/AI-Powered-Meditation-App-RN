...
const UpdateHire = () => {
  ...
  const [baseData, setBaseData] = useState({
    hireType: selectedHire?.hireType!,
    vehicle: selectedHire?.vehicle?._id!,
    driver: selectedHire?.driver?._id!,
    date: selectedHire?.date!,
    startTime: selectedHire?.startTime!,
    startLocation: selectedHire?.startLocation!,
    endTime: selectedHire?.endTime!,
    endLocation: selectedHire?.endLocation!,
    distance: selectedHire?.distance!,
    amount: selectedHire?.amount!,
  });
  ...
  const handleSubmit = async (event: any) => {
    ...
    await dispatch(updateHire(hireData)).then((res) => {
